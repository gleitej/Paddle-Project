...
function EditMap({
  ...
  useEffect(() => {
    ...
    if (singleRiver.gMap !== undefined) {
      setMarkers(singleRiver.gMap[0].markers);
      setLines(singleRiver.gMap[0].lines);
    }
  }, [loadState, getRiverById, loadMap, match.params.id, singleRiver.gMap]);
  ...
  return (
    <Fragment>
      {singleRiver._id !== match.params.id ? (
        <Spinner />
      ) : (
        <div>
              ...
              <div className='col-2'>
                ...
                <div className=''>
                  <div
                    ...
                    style={{ maxWidth: '30vw', height: '85.4vh' }}
                  >
